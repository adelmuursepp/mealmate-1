...
# cristina = User.create!(name: "cristina", email:"cristina@gmail.com", password:"hola123", address: "Calle Juan de Vera 15 Madrid", created_at: "2019-07-23 09:07:56")
# cristina.remote_photo_url = "https://d2v9y0dukr6mq2.cloudfront.net/video/thumbnail/VGqRaYUogil0szy2p/portrait-of-black-man-on-white-background_bjceb86ve_thumbnail-full07.png"
# cristina.save!

# cristina = User.create!(name: "cristina", email:"cristina@gmail.com", password:"hola123", address: "Calle de Alcala 125 Madrid")
# cristina.remote_photo_url = "https://i.pinimg.com/originals/0c/62/ed/0c62ed5d8b790774a54c390a34da0b2e.jpg"
# cristina.save!

# mariana = User.create!(name: "mariana", email:"mariana@gmail.com", password:"hola123", address: "Calle de Lagasca 56 Madrid")
# mariana.remote_photo_url = "https://d2v9y0dukr6mq2.cloudfront.net/video/thumbnail/VWWAFy05eikrfulkr/videoblocks-portrait-of-different-gender-people-morphing-into-other-different-appearance-of-man-and-woman-isolated-over-white-background-facemorph-concept_bdxdo-vkf_thumbnail-full01.png"
# mariana.save!

# cristina= User.create!(name: "cristina", email:"cristina@gmail.com", password:"hola123", address: "Calle de Hortaleza 100 Madrid")
# cristina.remote_photo_url = "https://ak0.picdn.net/shutterstock/videos/29117140/thumb/1.jpg"
# cristina.save!

# sofia = User.create!(name: "sofia", email:"sofia@gmail.com", password:"hola123", address: "Calle de Manuela Malasana 10 Madrid")
# sofia.remote_photo_url = "https://media.istockphoto.com/videos/portrait-of-young-woman-against-white-background-video-id1057552666?s=640x640"
# sofia.save!

# mariana = User.create!(name: "mariana", email:"mariana@gmail.com", password:"hola123", address: "Calle de Benigno Soto 9 Madrid" )
# mariana.remote_photo_url = "https://image.freepik.com/free-photo/portrait-handsome-man-isolated-white-background_38019-394.jpg"
# mariana.save!
...
# mariana = User.create!(name: "mariana", email:"mariana@gmail.com", password:"hola123", address: "Calle de Velarde 18 Madrid")
# mariana.remote_photo_url = "http://guessthelighting.com/wp-content/uploads/2012/02/steve_jobs_albert-watson.jpg"
# mariana.save!
...
Product.create!(name: "Tomato", price_cents: 3, details: "Summer time means tomato time! They are complex in flavor. A marriage between sweet and acidic while at the same time fruity. The best way to serve these juicy tomatoes is to slice and serve them with fresh mozzarella, basil, extra virgin olive oil and some red pepper flakes to add a kick to the classic Caprese Salad.", category: "vegetables", user_id:sofia.id , created_at: "2019-07-29 09:07:56",  remote_photo_url: "https://images.unsplash.com/photo-1546470427-227e2f27f02c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2775&q=80")


Product.create!(name: "Broccoli", price_cents: 5, details: "Broccoli is in season year around and its harvested by hand with a crisp texture and full flavor. Broccoli can be used in many dishes such as whole grain pasta primavera, casseroles such as brown rice and broccoli casserole, or roasted with a little oil and seasonings.", category: "vegetables", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1553175005-a1129d5c188c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=802&q=80")

Product.create!(name: "Corn", price_cents: 2, details: "Corn is carefully grown to be tender and bursting with flavor. We carefully select different varieties to be grown so that they are sweet and juicy.", category: "vegetables", user_id:mariana.id, remote_photo_url:"https://images.unsplash.com/photo-1554402100-8d1d9f3dff80?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80")

Product.create!(name: "Mushrooms", price_cents: 2, details: "Mushrooms are very versatile and equally tasty, fresh or cooked. Use raw in salads, sautéed, breaded or as an ingredient to enrich sauces, soups, stuffing or entrées.", category: "vegetables", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1504545102780-26774c1bb073?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=730&q=80")

Product.create!(name: "Carrots", price_cents: 1, details: "These tasty, ready-to-eat carrots are perfect for a warm pot of chicken noodle soup or served as a side dish to a steamy entrée. Rich in antioxidants and flavor, our carrots are an excellent on-the-go snack that’s as nutritious as it is delicious.", category: "vegetables", user_id:sofia.id, remote_photo_url:"https://images.unsplash.com/photo-1550081699-79c1c2e48a77?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80")

Product.create!(name: "Peas", price_cents: 4, details: "Peas are mildly flavored and can be served raw or cooked. Prepare traditionally as part of a stir-fry or blanch and serve cold.", category: "vegetables", user_id:mariana.id, remote_photo_url:"https://images.unsplash.com/photo-1553460165-3628ccff14d2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1647&q=80")
...
Product.create!(name: "Pineapple", price_cents: 2, details: "A delicious pineapple", category: "fruits", user_id:mariana.id, remote_photo_url:"https://images.unsplash.com/photo-1478005344131-44da2ded3415?ixlib=rb-1.2.1&auto=format&fit=crop&w=2848&q=80")

#eggs

Product.create!(name: "Brown eggs", price_cents: 3, details: "Brown eggs from chickens", category: "eggs", created_at: "2019-07-30 09:07:56", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1516448620398-c5f44bf9f441?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1647&q=80")

Product.create!(name: "White eggs", price_cents: 3, details: "White eggs from chickens", category: "eggs", user_id:mariana.id, remote_photo_url:"https://images.unsplash.com/photo-1489726933853-010eb1484d1a?ixlib=rb-1.2.1&auto=format&fit=crop&w=2090&q=80")

#wine
Product.create!(name: "White wine", price_cents: 8, details: "This bright and aromatic wine offers enticing layers of lemon and lime zest, as well as lovely notes of honeydew and nectarine. On the palate, refreshing acidity mingles with a subtle undercurrent of sweet fruit that carries through to a refreshing, vibrant finish.", category: "wine", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1561916542-c981c30f0cdb?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=738&q=80")

Product.create!(name: "Red wine", price_cents: 13, details: "Our red wine has a signature style that is dark in color, with rich fruit and ripe, velvety tannins – as approachable in youth as in maturity. We farm Cabernet grapes in eight of Napa’s 16 sub-appellations, with diversification enabling us to make the best possible wine in a given year. Our Cabernet offers layered, lush aromas and flavors, including cocoa, cassis and ripe dark berries.", category: "wine", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1546944517-4f38480ff03c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=676&q=80")

#herbs
Product.create!(name: "Parsley", price_cents: 3, details: "Parsley has a vibrant, aromatic flavour. Parsley is typically added toward the end of cooking as heat can destory its flavor. Parsley can be added to dishes with garlic to help soften the dish and alleviate any issues that may occur with bad breath.", category: "herbs", user_id:cristina.id, remote_photo_url:"https://images.unsplash.com/photo-1553217420-e8f8dde808f7?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1627&q=80")
